...
<html lang="en">
    <head>
        ...
        <meta name="discription" content="Omnifood is a premium food delivery service with the mission to bring affordable and healthy meals to as many people as possible.">
    ...
    <body>
        <header>
            <nav>
                <div class="row"> 
                    ...
                    <img src="resources/img/logo.png" alt="Omnifood logo" class="logo-sticky">
                    ...
                    <a class="mobile-nav-icon js--nav-icon"><ion-icon name="menu" class="menu"></ion-icon></a>
        ...
        <section class="section-steps" id="steps">
            ...
            <div class="row">
                <div class="col span-1-of-2 steps-box">
                    <img src="resources/img/app-iPhone.png" alt="Omnifood app on app iPhone" class="app-screen js--wp-2">
                </div>
                <div class="col span-1-of-2 steps-box">
                ...
                <form action="mailer-new.php" method="POST" class="contact-form">
                    <div class="row">
                        ...
                        if($_GET['success'] == -1) {
                            ...
                            Oop! Something went wrong try again!</div>";
                        }
                        ?>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col span-2-of-3">
                            <select name="find us" id="find_us">
        ...
        <footer>
            ...
            <div class="row">
                <p>Copyright &copy; 2020 by Omnifood (Gideon Mandu). All rights reserved. </p>
                <label>
                    <input type="checkbox" id="animation" name="animation" checked="checked">Enable Animation
                </label>
            </div>
        </footer>

        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.4/jquery.min.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/jay-respond@1.4.3/dest/respond.min.js"></script>
